...
import br.edu.ifrs.quantocustameucarroapi.model.Carro_;
import br.edu.ifrs.quantocustameucarroapi.model.Categoria_;
import br.edu.ifrs.quantocustameucarroapi.model.Lancamento;
import br.edu.ifrs.quantocustameucarroapi.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		criteria.select(builder.construct(ResumoLancamento.class
				...
				, root.get(Lancamento_.carro).get(Carro_.placa)));
